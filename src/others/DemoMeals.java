...
public class DemoMeals {
	...
	public static void main(String[] args) {
		...
		Menu m=new Menu();
		MyOrders myOrder=new MyOrders(m);
		...
		//Meal margaritaOgromnaMy=m.modifySizeMeal(margarita, sizeJumbo);
		
		myOrder.addMyMeal(margarita);//, Size.MIDDLE);
		myOrder.addMyMeal(margarita, Size.JUMBO);
		
		myOrder.addMyMeal(margarita, Dough.ITALIAN_STYLE);
		myOrder.addMyMeal(margarita, Dough.WITH_PHILADELPHIA_CHEESE);
		
		myOrder.printMyOrders();
		
		
		myOrder.removeMyMeal(gybena);

		myOrder.removeMyMeal(margarita);
