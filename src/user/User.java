...
public class User implements IPassword, ILogin, IMakeOrder {
	...
	public void setTelephoneNumber() {
		String query ="SELECT email from users where phone_number = ?";
		PreparedStatement st = null;
		ResultSet resultSet = null;
		String checker = null;
		String temp = null;
...
//				try {
//					st = MySQLConnector.conn.prepareStatement(query);
//					st.setString(1,setTelephoneNumber());
//					resultSet = st.executeQuery();
//					if(resultSet.next()) {
//						checker =  resultSet.getString("phone_number");
//						if(checker.equals(telephoneNumberInput)) {
...
//				} else {
//					System.out.println("The number already exists on our database");
//				}
